...
pub fn run_sa_build(source: &str, input: &str, output: &str, assembly: &str) -> Result<()> {
    ...
    let records = match source {
        ...
        "cosmic" => oxivep_sa::sources::cosmic::parse_cosmic_vcf(buf_reader, &chrom_map)?,
        "onekg" | "1000g" => oxivep_sa::sources::onekg::parse_onekg_vcf(buf_reader, &chrom_map)?,
        "topmed" => oxivep_sa::sources::topmed::parse_topmed_vcf(buf_reader, &chrom_map)?,
        "mitomap" => oxivep_sa::sources::mitomap::parse_mitomap(buf_reader, &chrom_map)?,
